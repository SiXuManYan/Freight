...
abstract class LibraryLibraryBaseListHttpSubscriber<T>(private var key: String?, viewLibrary: LibraryBaseView, showLoading: Boolean = true) :
    LibraryBaseHttpSubscriber<JsonObject>(viewLibrary, showLoading) {
