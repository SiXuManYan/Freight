package com.sugar.library.ui.widget.tabs;
...
/**
 * Created by Wangsw on 2020/5/29 11:27.
 * <br/>
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
     ...
     * 设置选中字号
     */
    public void setSelectTextScale(float selectTextScale) {
        this.selectTextScale = selectTextScale;
    }

    private float selectTextScale = 1.125f;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                if (selectTextSize != 0) {
                    ...
                    tv_tab_title.setScaleY(i == mCurrentTab ? selectTextScale : 1.0f);
                }
        ...
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                if (selectTextSize != 0) {
                    ...
                    tab_title.setScaleY(isSelect ? selectTextScale : 1.0f);
                }
