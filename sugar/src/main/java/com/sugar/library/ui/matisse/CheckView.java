...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{com.zhihu.matisse.R.attr.item_checkCircle_borderColor});
        int defaultColor = ResourcesCompat.getColor(
                getResources(), com.zhihu.matisse.R.color.zhihu_item_checkCircle_borderColor,
                getContext().getTheme());
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                com.zhihu.matisse.R.drawable.ic_check_white_18dp, context.getTheme());
    }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme()
                    .obtainStyledAttributes(new int[]{com.zhihu.matisse.R.attr.item_checkCircle_backgroundColor});
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), com.zhihu.matisse.R.color.zhihu_item_checkCircle_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
