 ...
 *
 */
class WechatLoginRegisterPresenter @Inject constructor(private var wechatLoginRegisterView: WechatLoginRegisterView) :
    BasePresenter(wechatLoginRegisterView) {
